    ...
    <header className='max--6xl mx-auto flex flex-wrap items-center justify-between h-20 p-4'>
        <div className='flex items-center gap-10 z-50'>
            ...
            <div className='hidden sm:flex gap-2 items-center'>
                <Link to="/" onClick={() => setContentType("movie")} className='hover:underline'>Movies</Link>
                <Link to="/" onClick={() => setContentType("tv")} className='hover:underline'>TV Shows</Link>
        ...
        <div className='flex gap-2 items-center z-50'>
            ...
            <img src={`${user.image}.png`} alt='avatar' className='h-8 rounded cursor-pointer'/>
